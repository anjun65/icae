<x-guest-layout-2023>
    <body class="antialiased bg-gray-100">
        <div class="relative items-top justify-center min-h-screen">
            <div class="max-w-6xl mt-12 mx-auto sm:px-6 lg:px-8">
                <br/>
                <div class="bg-white">
                ...
                <div class="mt-8 bg-white overflow-hidden shadow sm:rounded-lg">
                    ...
                    <div class="max-w-7xl mx-auto">
                        <div class="bg-white shadow overflow-hidden sm:rounded-lg">
                            <div class="px-4 py-5 sm:px-6 text-gray-600">
                                ...
                                <p class="text-xl text-bold text-gray-900">
                                    ...
                                    <li>Account name : RPL 137 BLU POLTEK BATAM UNTUK OPS PN PENDIDIKAN</li>
                                    <li>Account Number : 8802020143 - PT Bank Negara Indonesia (BNI) </li>
