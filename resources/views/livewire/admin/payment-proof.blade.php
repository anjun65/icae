        ...
        <div class="flex-col space-y-4">
            <x-table>
                <x-slot name="head">
                    ...
                    <x-table.heading>Kwitansi</x-table.heading>
                    <x-table.heading/>
                </x-slot>
    ...
    <form wire:submit.prevent="save">
        <x-modal.dialog wire:model.defer="showEditModal">
            ...
            <x-slot name="content">
                ...
                <x-input.group for="Invoice" label="Invoice">
                    <x-table.cell>
                        <a target="_blank" wire:click="invoice({{ $editing->id }})" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 focus:outline-none ">Invoice</a>
                    </x-table.cell>
                </x-input.group>

                <x-input.group for="Kwitansi" label="Kwitansi">
                    <x-table.cell>
                        @if($editing->verification_status == 'Approved')
                            <a target="_blank" wire:click="kwitansi({{ $editing->id }})" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 focus:outline-none ">
                                Kwitansi
                            </a> @else <a disabled="disabled" class="text-white bg-gray-700 hover:bg-gray-800 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 focus:outline-none ">Kwitansi</a>@endif
                            
                            <div wire:loading wire:target="kwitansi">
                                Processing...
                            </div>
                        </x-table.cell>
                </x-input.group>
