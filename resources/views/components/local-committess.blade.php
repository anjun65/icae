    ...
    <div class="bg-white shadow overflow-hidden sm:rounded-lg">
        <div class="w-full">
            <table class="w-full py-5">
                <thead>
                    <tr tabindex="0" class="focus:outline-none h-16 w-full text-sm  bg-gray-50  text-gray-800">
                ...
                <tbody class="w-full">
                    <tr tabindex="0" class="focus:outline-none h-20 text-sm  text-gray-800 hover:bg-gray-100 border-b border-t border-gray-100">
                        <td class="pl-4 cursor-pointer">
                            <div class="flex items-center">
                                <div>
                                    <p class="font-medium">Steering Committee</p>
                                </div>
                            </div>
                        </td>
                        <td class="pl-12">
                            <p class="text-sm font-medium  text-gray-800">Uuf Brajawidagda, Ph.D</p>
                            <p class="text-sm font-medium  text-gray-800">Daniel Sutopo Pamungkas, Ph.D</p>
                            <p class="text-sm font-medium  text-gray-800">Dr. Budi Sugandi, M.Eng</p>
                            <p class="text-sm font-medium  text-gray-800">Ahmad Riyad Firdaus, Ph.D</p>
                            <p class="text-sm font-medium  text-gray-800">Metta Santiputri, Ph.D</p>
                        </td>
                    ...
                    <tr tabindex="0" class="focus:outline-none h-20 text-sm  text-gray-800 hover:bg-gray-100 border-b border-t border-gray-100">
                        <td class="pl-4 cursor-pointer">
                            <div class="flex items-center">
                                <div>
                                    <p class="font-medium">Chairman</p>
                                </div>
                            </div>
                        </td>
                        <td class="pl-12">
