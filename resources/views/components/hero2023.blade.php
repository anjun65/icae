            ...
            <div class="absolute inset-0 flex items-center justify-center z-10 pointer-events-none">
                <div>
                    ...
                    {{-- <div class="hidden sm:flex mt-6 max-w-sm mx-auto flex-col justify-center items-center gap-4 sm:flex-row md:mt-8 lg:mt-10">
                        <a class="w-100 group relative inline-flex border border-slate-600 focus:outline-none w-full sm:w-auto pointer-events-auto" href="https://ieeexplore.ieee.org/xpl/conhome/8556142/proceeding" target="_blank">
                            <span class="w-full inline-flex items-center justify-center self-stretch px-4 py-2 text-sm text-slate-600 text-center font-bold uppercase bg-white ring-1 ring-slate-600 ring-offset-1 transform transition-transform group-hover:-translate-y-1 group-hover:-translate-x-1 group-focus:-translate-y-1 group-focus:-translate-x-1">
                               Proceeding 2018 
                            </span>
                        </a>

                        <a class="group relative inline-flex border border-slate-600 focus:outline-none w-full sm:w-auto pointer-events-auto" href="https://ieeexplore.ieee.org/xpl/conhome/9211296/proceeding" target="_blank">
                            <span class="w-full inline-flex items-center justify-center self-stretch px-4 py-2 text-sm text-slate-600 text-center font-bold uppercase bg-white ring-1 ring-slate-600 ring-offset-1 transform transition-transform group-hover:-translate-y-1 group-hover:-translate-x-1 group-focus:-translate-y-1 group-focus:-translate-x-1">
                               Proceeding 2019
                            </span>
                        </a>
                        ...
                        <a class="group relative inline-flex border border-slate-600 focus:outline-none w-full sm:w-auto pointer-events-auto" href="https://ieeexplore.ieee.org/xpl/conhome/9350316/proceeding" target="_blank">
                            <span class="w-full inline-flex items-center justify-center self-stretch px-4 py-2 text-sm text-slate-600 text-center font-bold uppercase bg-white ring-1 ring-slate-600 ring-offset-1 transform transition-transform group-hover:-translate-y-1 group-hover:-translate-x-1 group-focus:-translate-y-1 group-focus:-translate-x-1">
                               Proceeding 2020 
                            </span>
                        </a>
                ...
                @foreach (range(1, 80) as $i)
                    @if ($i === 61)
                        ...
                        <div class="even:-translate-y-1/2">
                            <div class="transition duration-300 rounded-2xl aspect-square flex items-center justify-center text-4xl opacity-25 shadow-[32px_32px_40px_-20px_theme(colors.gray.400)]" :class="current === 'vue' ? '!opacity-100 !shadow-[64px_64px_100px_-20px_theme(colors.slate.400)] -translate-y-1 -translate-x-1' : ''" @mouseover="highlight('vue')" @mouseout="resume">
                                <img src="{{ asset('img/big-data.png') }}" alt="Big Data" class="w-1/2">
                            </div>
                        </div>
                    @elseif ($i === 54)
                        <!-- React -->
                        <div class="even:-translate-y-1/2">
                            <div class="transition duration-300 rounded-2xl aspect-square flex items-center justify-center text-4xl opacity-25 shadow-[32px_32px_40px_-20px_theme(colors.gray.400)]" :class="current === 'react' ? '!opacity-100 !shadow-[64px_64px_100px_-20px_theme(colors.slate.400)] -translate-y-1 -translate-x-1' : ''" @mouseover="highlight('react')" @mouseout="resume">
                                <img src="{{ asset('img/industrial-robot.png') }}" alt="Industrial Robot" class="w-1/2">
                            </div>
                        </div>
                    @elseif ($i === 19)
                        <!-- Solid -->
                        <div class="even:-translate-y-1/2">
                            <div class="transition duration-300 rounded-2xl aspect-square flex items-center justify-center text-4xl opacity-25 shadow-[32px_32px_40px_-20px_theme(colors.gray.400)]" :class="current === 'solid' ? '!opacity-100 !shadow-[64px_64px_100px_-20px_theme(colors.slate.400)] -translate-y-1 -translate-x-1' : ''" @mouseover="highlight('solid')" @mouseout="resume">
                                <img src="{{ asset('img/iot.png') }}" alt="IOT" class="w-1/2">
                            </div>
                        </div>
                    @elseif ($i === 42)
                        <!-- Svelte -->
                        <div class="even:-translate-y-1/2">
                            <div class="transition duration-300 rounded-2xl aspect-square flex items-center justify-center text-4xl opacity-25 shadow-[32px_32px_40px_-20px_theme(colors.gray.400)]" :class="current === 'svelte' ? '!opacity-100 !shadow-[64px_64px_100px_-20px_theme(colors.slate.400)] -translate-y-1 -translate-x-1' : ''" @mouseover="highlight('svelte')" @mouseout="resume">
                                <img src="{{ asset('img/blockchain.png') }}" alt="Blockchain" class="w-1/2">
                            </div>
                        </div>
                    @elseif ($i === 21)
                        <!-- Next -->
                        <div class="even:-translate-y-1/2">
                            <div class="transition duration-300 rounded-2xl aspect-square flex items-center justify-center text-4xl opacity-25 shadow-[32px_32px_40px_-20px_theme(colors.gray.400)]" :class="current === 'next' ? '!opacity-100 !shadow-[64px_64px_100px_-20px_theme(colors.slate.400)] -translate-y-1 -translate-x-1' : ''" @mouseover="highlight('next')" @mouseout="resume">
                                <img src="{{ asset('img/physics.png') }}" alt="Physics" class="w-1/2">    
                            </div>
                        </div>
                    @elseif ($i === 51)
                        <!-- Nuxt -->
                        <div class="even:-translate-y-1/2">
                            <div class="transition duration-300 rounded-2xl aspect-square flex items-center justify-center text-4xl opacity-25 shadow-[32px_32px_40px_-20px_theme(colors.gray.400)]" :class="current === 'nuxt' ? '!opacity-100 !shadow-[64px_64px_100px_-20px_theme(colors.slate.400)] -translate-y-1 -translate-x-1' : ''" @mouseover="highlight('nuxt')" @mouseout="resume">
                               <img src="{{ asset('img/vr-glasses.png') }}" alt="VR Glasses" class="w-1/2">
                            </div>
                        </div>
                    @elseif ($i === 39)
                        <!-- Alpine.js -->
                        <div class="even:-translate-y-1/2">
                            <div class="transition duration-300 rounded-2xl aspect-square flex items-center justify-center text-4xl opacity-25 shadow-[32px_32px_40px_-20px_theme(colors.gray.400)]" :class="current === 'alpine' ? '!opacity-100 !shadow-[64px_64px_100px_-20px_theme(colors.slate.400)] -translate-y-1 -translate-x-1' : ''" @mouseover="highlight('alpine')" @mouseout="resume">
                                <img src="{{ asset('img/iot.png') }}" alt="IOT" class="w-1/2">    
                            </div>
                        </div>
                    @else
...
{{-- <section class="pt-12 ">
    <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
        <a href="#" class="inline-flex justify-between items-center py-1 px-1 pr-4 mb-7 text-sm text-gray-700 bg-gray-100 rounded-full dark:bg-gray-800 hover:bg-gray-200" role="alert">
