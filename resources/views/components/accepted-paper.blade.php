  ...
  <div class="max-w-7xl mx-auto">
    <div class="bg-white shadow overflow-hidden sm:rounded-lg">
        <div class="px-4 py-5 sm:px-6">
            <p class="text-medium leading-6 text-gray-900">the 5th International Conference on Applied Engineering (ICAE 2022) will be held virtually on Wednesday, October 5th 2022 as scheduled. Please note that the times shown in the schedule are in Western Indonesia Time (GMT+7), and we will be using Zoom as the virtual conference platform.</p>
                <br/>
            <p>
                <ol>
                    ...
                    <li>4. During the presentation, please use the ICAE virtual background <a href="img/zoom-background.jpg" class="text-indigo-500 font-bold" target="_blank">Zoom Background</a>.</li>
