  ...
  <div class="max-w-7xl mx-auto">
    <section class="bg-white">
        <div class="max-w-5xl px-6 py-16 mx-auto">
            <h2 class="text-3xl font-semibold text-gray-800">About the Conference</h2>
            <p class="mt-4 text-gray-600">The term VUCA was first introduced in military context, which stands for Volatility, Uncertainty, Complexity, and Ambiguity. Volatility means the nature and dynamics of change, and the nature and speed of change forces and change catalysts. Uncertainty means the lack of predictability, the prospects for surprise, and the sense of awareness and understanding of issues and events. Complexity means the multiplex of forces, the confounding of issues, no cause-and-effect chain and confusion that surrounds organization. Ambiguity means the haziness of reality, the potential for misreads, and the mixed meanings of conditions; cause-and-effect confusion. The VUCA world is manifested in the unpredictable nature of the current state of the world like the situation of COVID-19 we are right now. This is the challenge for researchers, academics, students, and practitioners to contribute for the advancement in applied research and technology to survive and continue to emerge in these uncertain situations.</p>
            <div class="grid gap-8 mt-10 md:mt-20 md:grid-cols-2">
                <div class="flex space-x-4">
                    ...
                    <div>
                        <h4 class="text-xl font-medium text-gray-800">ECONOMICS TRACK</h4>
                ...
                <div class="flex space-x-4">
                    ...
                    <div>
                        <h4 class="text-xl font-medium text-gray-800">ACCOUNTINGS TRACK</h4>
                        <p class="max-w-lg mt-4 text-gray-600 pb-4">Vitae nulla euismod velpretium tellus accumsan nulla nunc
